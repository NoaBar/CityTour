...
public class ParksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attractions.add(new Attraction("Jerusalem Park", "It's everywhere!", "The park is divided into 4 parts around the city, each part is different from the other. Choose the part that is the most suitable for you!",
